...
public class YoutubeActivity extends YouTubeBaseActivity
    ...
    static final String GOOGLE_API_KEY = BuildConfig.ApiKey;
    static final String YOUTUBE_VIDEO_ID = "nPT790DZqjs";
    static final String YOUTUBE_PLAYLIST = "PLSrTLXbH_P3blY6a3NHEeK2MOxZNNgbsM";
...
//        layout.addView(button1);
    ...
    private YouTubePlayer.PlayerStateChangeListener playerStateChangeListener = new YouTubePlayer.PlayerStateChangeListener() {
        ...
        public void onAdStarted() {
            Toast.makeText(YoutubeActivity.this, "Click add now, make the video creator rich!", Toast.LENGTH_LONG).show();
        }
